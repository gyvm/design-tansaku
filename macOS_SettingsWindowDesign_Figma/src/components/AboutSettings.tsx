...
export function AboutSettings({ isDarkMode }: AboutSettingsProps) {
  return (
    <div className="p-8">
      <h1 className="text-[24px] text-slate-900 dark:text-white mb-2">このアプリについて</h1>
      ...
      <div className="mb-6">
        <div className="bg-white/60 dark:bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 border border-slate-200/60 dark:border-slate-700/60">
          ...
          <p className="text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
            TypoZero is a high-precision text proofreading utility for business professionals.
            With a single keyboard shortcut, you can quickly check your writing in any situation.
          </p>
        </div>
      </div>
      ...
      <div className="mb-6">
        <div className="bg-white/60 dark:bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 border border-slate-200/60 dark:border-slate-700/60">
          <h3 className="text-[15px] text-slate-900 dark:text-white mb-4">リンク / Links</h3>
      ...
      <div className="mb-6">
        <div className="bg-white/60 dark:bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 border border-slate-200/60 dark:border-slate-700/60">
          <h3 className="text-[15px] text-slate-900 dark:text-white mb-4">クレジット / Credits</h3>
          
          <div className="space-y-3">
            <div>
              <p className="text-[13px] text-slate-700 dark:text-slate-300">
                Developed by <span className="text-slate-900 dark:text-white">TypoZero Team</span>
              </p>
            </div>
